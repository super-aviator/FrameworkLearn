...
import com.xqk.learn.springboot.zookeeper.demo.master_follower.enums.WorkerStatusEnum;
...
public class Worker {
    ...
    public void registerAsync() {
        ...
        zookeeper.create(workerPath, WorkerStatusEnum.IDLE.toString().getBytes(), ZooDefs.Ids.OPEN_ACL_UNSAFE, CreateMode.EPHEMERAL_SEQUENTIAL, registerCallback, null);
    }
