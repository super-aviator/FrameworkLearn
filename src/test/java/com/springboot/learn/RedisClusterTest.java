...
//    @Test
//    public void testIntegerRedisTemplate(){
//        integerRedisTemplate.opsForValue().set("int",1);
//        Assert.assertEquals(integerRedisTemplate.opsForValue().get("int"),Integer.valueOf(1));
//    }
}
